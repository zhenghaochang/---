    ...
    <div class="base_div">
            ...
            <div class="main_div">
                ...
                <div class="card_div">
                    ...
                    <div class="card" v-for="(item,i) in phoneList" @click="router.push({path:'/goods',query:{id:item.id}})" :key="i">
                    ...
                    <div class="card" @click="()=>router.push('/allGoods')">浏览更多>></div>
                </div>
                <!-- 手机部分END -->
                <br>
                <!-- 家电部分 -->
                ...
                <div class="card_div">
                        ...
                        <div class="card" v-for="(item,i) in jiadianList" @click="router.push({path:'/goods',query:{id:item.id}})" :key="i">
                            <img style="width:70%;height:auto" :src="phone1" alt="">
                            <span class="nameSpan">{{item.goodsName}}</span>
                            <span class="advantageSpan">{{item.goodsAdvantage}}</span>
                            <div style="display:flex;justify-content:space-around;align-items:flex-end;width:150px">
                        ...
                        <div class="card" @click="()=>router.push('/allGoods')">
                            浏览更多>>
                        </div>
                </div>
                <!-- 家电部分END -->
                ...
                <div class="card_div">
                        ...
                        <div class="card" v-for="(item,i) in peijianList" @click="router.push({path:'/goods',query:{id:item.id}})" :key="i">
                            <img style="width:70%;height:auto" :src="phone1" alt="">
                            <span class="nameSpan">{{item.goodsName}}</span>
                            <span class="advantageSpan">{{item.goodsAdvantage}}</span>
                            <div style="display:flex;justify-content:space-around;align-items:flex-end;width:150px">
