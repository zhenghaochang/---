    ...
    <div class="base_div">
        ...
        <div class="main_div">
            ...
            <div style="width:50%;display:flex;flex-direction:column;align-items:center;margin-top:50px">
                ...
                <br>
                <br>
                <span style="align-self:flex-end;font-size:35px;color:rgb(255,130, 45);margin-right:15px" v-if="goods.goodsPriceNew == goods.goodsPrice">{{goods.goodsPriceNew}}</span>
