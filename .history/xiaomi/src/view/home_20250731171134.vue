...
import phone2 from '../assets/img/phone1.png'
import phone3 from '../assets/img/phone1.png'
import phone4 from '../assets/img/phone1.png'
import phone5 from '../assets/img/phone1.png'
import phone6 from '../assets/img/phone1.png'
import phone7 from '../assets/img/phone1.png'
    ...
    <div class="base_div">
            ...
            <div class="main_div">
                <div class="card_div">
                    ...
                    <div class="card" v-for="item in phoneList" :key="item">
                        <img src="" alt="">
                    </div>
