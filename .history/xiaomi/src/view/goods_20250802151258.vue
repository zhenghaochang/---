    ...
    <div class="base_div">
        ...
        <div class="main_div">
            ...
            <div style="width:50%;display:flex;flex-direction:column;align-items:center;margin-top:50px">
                ...
                <br>
                <br>
                <span style="align-self:flex-end;font-size:25px" v-if="goods.goodsPriceNew == goods.goodsPrice">{{goods.goodsPriceNew}}</span>
                <div style="width:100%;display:flex;justify-content:flex-end;align-items:flex-end" v-else>
                    <span style="font-size:35px;color:rgb(255,130, 45);margin-right:15px">{{goods.goodsPriceNew}}</span>
                    <span style="color:rgb(150,150,150);font-size:25px;text-decoration: line-through">{{goods.goodsPrice}}</span>
                </div>
            </div>
        </div>
