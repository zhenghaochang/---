    ...
    <div class="base_div">
            ...
            <div class="main_div">
                ...
                <div style="width:80%;font-size:25px;color:rgb(80,80,80);margin-top:20px;display:flex;justify-content:space-between">
                        家电
                        <el-menu :ellipsis="false" :default-active="defaultIndex" mode="horizontal" class="jiadian_menu" background-color="rgb(245,245,245)" active-text-color="rgb(255,130, 45)">
                            <el-menu-item class="jiadian_menu_item" index="hot" @select="">热门</el-menu-item>
                            <el-menu-item class="jiadian_menu_item" index="tv">电视影音</el-menu-item>
                        </el-menu>
                </div>
                <div class="card_div">
                        <div>
