        ...
        <div class="main_div">
            ...
            <div style="width:50%;display:flex;flex-direction:column;align-items:center;margin-top:50px">
                ...
                <div style="width:100%;display:flex;justify-content:flex-end">
                    <el-button style="width:30%;height:50px;color:white" color="rgb(255,130,45)" @click="addToCart">加入购物车</el-button>
                    <el-button style="width:30%;height:50px;color:white" color="rgb(255,130,45)" @click="addToCart">数量+1</el-button>
