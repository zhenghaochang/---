...
import {selectParam,goodsList,total,getGoodsList} from '../global/global'
...
function tabChange(name){
    selectParam.value.currentPage = 1
    selectParam.value.categoryId = name
    getGoodsList()
}
...
<template>
    <div class="base_div">
        ...
        <div class="main_div">
            <div class="card_div">
                <div class="card" @click="router.push({path:'/goods',query:{id})" v-for="(item,i) in goodsList" :key="i">
