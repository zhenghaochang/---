...
async function getGoodsList(){
    let {data} = await request.post("/goods/getAllGoodsList",selectParam)
}
...
<template>
    <div class="base_div">
        ...
        <div class="main_div">
            ...
            <div>
                <el-pagination background layout="prev, pager, next" @Current-change="" page-size=15 :current-page="currentPage" :total="total" />
            </div>
        </div>
        <!-- 主体部分END -->
    </div>
