            ...
            <div class="main_div">
                <div class="card_div">
                    ...
                    <div class="card" v-for="(item,i) in phoneList" :key="i">
                        ...
                        <div style="display:flex;justify-content:space-around;align-items:flex-end;width:200px">
                            <span style="font-size:22px;color:rgb(255,130, 45)">{{item.goodsPriceNew}}元</span>
                            <span style="color:rgb(150,150,150)" v-if="item.goodsPriceNew == item.goodsPrice">{{item.goodsPrice}}元</span>
                        </div>
                    </div>
