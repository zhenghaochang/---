...
async function getJiadianGoodsList(){
    //后端接收数组类型的categoryId
...
<template>
    <div class="base_div">
            ...
            <div class="main_div">
                ...
                <br>
                <!-- 家电部分 -->
                <div style="width:80%;font-size:25px;color:rgb(80,80,80);margin-top:20px;display:flex;justify-content:space-between">
                        家电
                        <el-menu :default-active="defaultIndex" mode="horizontal" class="jiadian_menu" background-color="rgb(245,245,245)" active-text-color="rgb(255,130, 45)">
                            <el-menu-item class="jiadian-menu-item" index="0">热门</el-menu-item>
                            <el-menu-item class="jiadian-menu-item" index="1">电视影音</el-menu-item>
                        </el-menu>
                </div>
                <div class="card_div">
                        <div>
                        ...
                        <div class="card" v-for="(item,i) in jiadianList" :key="i">
                            <img style="width:70%;height:auto" :src="jiadian1" alt="">
                            <span class="nameSpan">{{item.goodsName}}</span>
                            <span class="advantageSpan">{{item.goodsAdvantage}}</span>
                            <div style="display:flex;justify-content:space-around;align-items:flex-end;width:150px">
                                <span style="font-size:22px;color:rgb(255,130, 45)">{{item.goodsPriceNew}}元</span>
...
.jiadian_menu--horizontal .jiadian_menu_item:hover,
.jiadian_menu--vertical .jiadian_menu_item:hover {
