        ...
        <div class="main_div">
            ...
            <div style="width:50%;display:flex;flex-direction:column;align-items:center;margin-top:50px">
                ...
                <div style="width:100%;display:flex;justify-content:flex-end;align-items:flex-end" v-else>
                    <span style="font-size:25px;color:rgb(255,130, 45);margin-right:20px">{{goods.goodsPriceNew}}</span>
                    <span style="color:rgb(150,150,150);text-decoration: line-through">{{goods.goodsPrice}}</span>
                </div>
            </div>
        </div>
