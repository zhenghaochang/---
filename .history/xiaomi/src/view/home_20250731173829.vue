            ...
            <div class="main_div">
                <div class="card_div">
                    ...
                    <div class="card" v-for="(item,i) in phoneList" :key="i">
                        ...
                        <div style="display:flex;justify-content:space-around;width:200px;background:blue">
                            <span>{{item.goodsPriceNew}}</span>
                            <span v-if="item.goodsPriceNew == item.goodsPrice">{{item.goodsPrice}}</span>
                        </div>
                    </div>
