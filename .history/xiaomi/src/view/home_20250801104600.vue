...
const defaultJiadian = ref('hot')
const defaultPeijian = ref('')
    ...
    <div class="base_div">
            ...
            <div class="main_div">
                ...
                <div style="width:80%;font-size:25px;color:rgb(80,80,80);margin-top:20px;display:flex;justify-content:space-between;align-items:center">
                        ...
                        >
                            <el-menu-item class="jiadian_menu_item" index="hot">热门</el-menu-item>
                            <el-menu-item class="jiadian_menu_item" index="ps">保护套</el-menu-item>
                            <el-menu-item class="jiadian_menu_item" index="charger">充电器</el-menu-item>
                        </el-menu>
                </div>
                <div class="card_div">
                        <div>
