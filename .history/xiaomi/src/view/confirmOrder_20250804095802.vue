...
function total(){
    for(const i = 0;i<orderList.value.length;i++){
        totalAmount.value += orderList.value[i].goodsNumber * orderList.value[i].goodsPrice
    }
}
...
<template>
    <div class="base_div">
        ...
        <div style="width:80%;display:flex;justify-content:flex-end">
            ...
            <el-button style="width:210px;height:70px;color:white" color="rgb(255,130, 45)">确认支付</el-button>
        </div>
