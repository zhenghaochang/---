...
<template>
    <div class="base_div">
        <el-button color="rgb(80,80,80)" @click="loginVisible = true" v-if="user.id==0" link>登录|注册</el-button>
        <div style="display:flex;align-items:center;margin-right:10px">
            <el-button color="rgb(80,80,80)" link>欢迎{{user.name}}</el-button>
            <el-button color="rgb(80,80,80)" link>退出登录</el-button>
        </div>
        <el-button color="rgb(80,80,80)" link>我的订单</el-button>
        <el-button color="rgb(80,80,80)" link>我的收藏</el-button>
        <el-button  style="background-color:rgb(255,130, 45);margin-right:150px;width:100px"  link>购物车({{user.numInCart}})</el-button>
        ...
        <!-- 登录窗口END -->
        <!-- 注册窗口END -->
        <el-dialog v-model="registVisible"  title="注册" width="300">
            <el-form :model="registForm" ref="registFormRef" :rules="rules">
                ...
                <el-form-item label="确认密码" prop="rePassword" :label-width="70">
