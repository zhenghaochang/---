...
const validateUsername = (rule,value,callback)=>{
  ...
  const rules = {
    ...
    rePassword:[{required:true,message:'密码必须大于4位',validator:validatePassword}]
  }
...
<template>
    <div class="base_div">
        ...
        <div style="display:flex;align-items:center;margin-right:10px" v-else>
            ...
            <el-button color="rgb(80,80,80)" @click="()=>{store.logout()}" link>退出登录</el-button>
        </div>
